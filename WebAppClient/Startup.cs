...
namespace WebAppClient
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddHttpClient<IBarberService, BarberService>(client =>
            {
                client.BaseAddress = new Uri(this.Configuration.GetSection("ApiOptions")["Url"]);
            });
            services.AddHttpClient<IHaircutService, HaircutService>(client =>
            {
                client.BaseAddress = new Uri(this.Configuration.GetSection("ApiOptions")["Url"]);
            });
            ...
            services.AddHttpClient<ILoyaltyService, LoyaltyService>(client =>
            {
                client.BaseAddress = new Uri(this.Configuration.GetSection("ApiOptions")["Url"]);
            });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseEndpoints(endpoints =>
            {
                endpoints.MapControllerRoute(
                    name: "default",
                    pattern: "{controller=Barber}/{action=List}"
                    );
            });
        }
    }
